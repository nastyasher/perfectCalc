...
export const NewProduct = withRouter(({actionAddNewProduct, history}) => {
    ...
    return     <div className="new-product-block">
        ...
        <form className="row new-product" onSubmit={(e) => {
            e.preventDefault()
            actionAddNewProduct(newProduct, history)
            ...
            <div className="col-12 col-md-6">
                ...
                <div className="error text-danger error-prod" style={{display: newProduct.calories.length < 1 || newProduct.calories.length > 8 ? "" : "none"}}> Введите корректные калории </div>
            </div>
            <div className="col-12 col-md-6">
                ...
                <div className="error text-danger error-prod" style={{display: newProduct.proteins.length < 1 || newProduct.proteins.length > 7 ? "" : "none"}}> Введите корректные белки </div>
            </div>
            <div className="col-12 col-md-6">
                ...
                <div className="error text-danger error-prod" style={{display: newProduct.fats.length < 1 || newProduct.fats.length > 7 ? "" : "none"}}> Введите корректные жиры </div>
            </div>
            <div className="col-12 col-md-6">
                ...
                <div className="error text-danger error-prod" style={{display: newProduct.carbohydrates.length < 1 || newProduct.carbohydrates.length > 7 ? "" : "none"}}> Введите корректные углеводы </div>
            </div>
